...
module {
    ...
    public type CallType = { 
        ...
        // };
        #This: {
            #getNonce: (_txi: Nat, _toids: ?[Nat]);
            #createTx: (_txi: Nat);
            #createTx_comp: (_txi: Nat);
            #signTx: (_txi: Nat);
            #sendTx: (_txi: Nat);
        };
    };
    ...
    public type Receipt = { 
        ...
        // };
        #This: {
            #getNonce: {txi: Nat; address: Minter.EthAddress; nonce: Minter.Nonce};
            #createTx: {txi: Nat; rawTx: [Nat8]; txHash: Minter.TxHash};
            #createTx_comp;
            #signTx: {txi: Nat; signature: Blob; rawTx: [Nat8]; txHash: Minter.TxHash};
            #sendTx: {txi: Nat; result: Result.Result<Minter.TxHash, Text>; rpcId: Minter.RpcId};
        };
    };
